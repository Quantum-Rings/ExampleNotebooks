...
# This file is derived from the qiskit community project qiskit nature
...
class Copyright(Magics):
    ...
    def qiskit_copyright(self, line="", cell=None):
        ...
        html += "<p>Modifications &copy; Copyright Quantum Rings Inc, 2025<br>"
        html += "Modified from the originals<br>"
        html += "Added support for Quantum Rings QrEstimatorV2 class. </p>"
        html += "</div>"
